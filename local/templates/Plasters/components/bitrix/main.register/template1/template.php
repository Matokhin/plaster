...
<table>
			...
			<h1 colspan="2"><?=GetMessage("AUTH_REGISTER")?></h1>
		...
		<?array_unshift($arResult["SHOW_FIELDS"], "NAME", "PERSONAL_PHONE");?>
...
<?foreach ($arResult["SHOW_FIELDS"] as $FIELD):?>
	...
	switch ($FIELD)
	{
		case "PASSWORD":
			?>
			<label for="#"><?echo GetMessage("REGISTER_FIELD_PASSWORD")?></label><br>
			<input class="subscribe_text"type="password" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" class="form-info"><br><br>
...
<?
		...
		case "CONFIRM_PASSWORD":
			?><label for="#"><?echo GetMessage("REGISTER_FIELD_CONFIRM_PASSWORD")?></label><br>
			<input class="subscribe_text"type="password" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" class="form-info"><br><br>
			<?
			break;
		...
		default:
			...
			?>
			<label for="#"><?=GetMessage("REGISTER_FIELD_".$FIELD)?>:<?if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"):?><span class="starrequired">*</span><?endif?></label><br>
			<input class="subscribe_text" type="text" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" class="form-info"><br><br>
			<?
...
?>
	...
	<tfoot>
		<tr>
			...
			<td><input value="<?=GetMessage("AUTH_REGISTER")?>" type="submit" name="register_submit_button" class="registration_submit subscribe_button"></input></td>
		</tr>
	</tfoot>
</table>
</form>

<p class="reg_required" style="color: red;" ></p>
